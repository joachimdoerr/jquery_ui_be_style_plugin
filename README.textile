...
jQuery UI ist ein Plugin für das Redaxo Addon "be_style" welches aber der Redaxo Version 4.2.0 eingesetzt werden kann. Das Plugin stellt die aktuelle jQuery UI 1.10.0 für das Redaxo Backend bereit.
